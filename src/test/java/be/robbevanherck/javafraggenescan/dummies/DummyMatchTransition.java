...
public class DummyMatchTransition extends MatchTransition {
    public PathProbability lowerPathProbability = new PathProbability(HMMState.INSERT_1, 0.1);
    public PathProbability lowPathProbability = new PathProbability(HMMState.MATCH_1, 0.2);
    public PathProbability middlePathProbability = new PathProbability(HMMState.MATCH_2, 0.3);
    public PathProbability highPathProbability = new PathProbability(HMMState.START, 0.4);
